...
import { RefreshCcw, ArrowLeft, CheckCircle2, HelpCircle, Coins } from 'lucide-react';
...
const Refund = () => {
  ...
  const sections = [
    {
      title: t('refund_sec1_title'),
      text: t('refund_sec1_text'),
      icon: <CheckCircle2 size={22} color="var(--land-primary)" />
    },
    {
      title: t('refund_sec2_title'),
      text: t('refund_sec2_text'),
      icon: <HelpCircle size={22} color="var(--land-primary)" />
    },
    {
      title: t('refund_sec3_title'),
      text: t('refund_sec3_text'),
      icon: <Coins size={22} color="var(--land-primary)" />
    }
  ];
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <div style={{
            ...
            <RefreshCcw size={40} color="var(--land-primary)" />
          </div>
