...
import { Mail, Headset, ArrowLeft, Clock, Globe } from 'lucide-react';
...
const Contact = () => {
  ...
  const sections = [
    {
      title: t('contact_sec1_title'),
      text: t('contact_sec1_text'),
      icon: <Clock size={22} color="var(--land-primary)" />
    },
    {
      title: t('contact_sec2_title'),
      text: t('contact_sec2_text'),
      icon: <Globe size={22} color="var(--land-primary)" />
    }
  ];
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <div style={{
            ...
            <Headset size={40} color="var(--land-primary)" />
          </div>
        ...
        {/* Intro / Support Email Card */}
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          className="card glass" 
          style={{ padding: '32px', marginBottom: '30px', borderLeft: '4px solid var(--land-primary)', textAlign: 'center' }}
        >
          <p style={{ color: 'var(--text-primary)', fontSize: '1.15rem', opacity: 0.95, lineHeight: '1.7', fontWeight: 550, marginBottom: '24px' }}>
            {t('contact_intro')}
          </p>
