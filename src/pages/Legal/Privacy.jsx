...
import { Lock, ArrowLeft, Database, Users, CreditCard, ShieldAlert } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      icon: <Database size={22} color="var(--land-primary)" />
    },
    {
      title: t('privacy_sec2_title'),
      text: t('privacy_sec2_text'),
      icon: <Users size={22} color="var(--land-primary)" />
    },
    {
      title: t('privacy_sec3_title'),
      text: t('privacy_sec3_text'),
      icon: <CreditCard size={22} color="var(--land-primary)" />
    },
    {
      title: t('privacy_sec4_title'),
      text: t('privacy_sec4_text'),
      icon: <ShieldAlert size={22} color="var(--land-primary)" />
    }
  ];
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <div style={{
            ...
            <Lock size={40} color="var(--land-primary)" />
          </div>
